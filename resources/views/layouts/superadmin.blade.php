    ...
    <div class="h-screen flex overflow-hidden" x-data="{ sidebarOpen: false, darkMode: localStorage.getItem('darkMode') === 'true' }" x-init="$watch('darkMode', value => { localStorage.setItem('darkMode', value); if (value) { document.documentElement.classList.add('dark') } else { document.documentElement.classList.remove('dark') } }); if (darkMode) document.documentElement.classList.add('dark')">
        ...
        <div class="flex-1 flex flex-col h-full overflow-hidden md:ml-64">
            ...
            <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow px-4 sm:px-6 py-3 flex justify-between items-center flex-shrink-0">
                ...
                <h1 class="text-lg font-semibold text-gray-900 dark:text-white">Balt-Bep Shipping Express</h1>

                <!-- Dark Mode Toggle and Dropdown -->
                <div class="flex items-center space-x-2">
                    <button @click="darkMode = !darkMode" class="p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center text-gray-700 dark:text-gray-300 hover:text-blue-600 focus:outline-none">
